...
var DOMEvent = this.DOMEvent = new Type('DOMEvent', function(event, win){
	...
	} else if (type == 'tap' || type == 'click' || type == 'dblclick' || type == 'contextmenu' || type == 'wheel' || type == 'DOMMouseScroll' || type.indexOf('mouse') == 0){
...
Element.NativeEvents = {
	tap:2, click: 2, dblclick: 2, mouseup: 2, mousedown: 2, contextmenu: 2, //mouse buttons
...
Request.JSON = new Class({
	...
	initialize: function(options){
		Request.prototype.initialize.apply(this,arguments);
